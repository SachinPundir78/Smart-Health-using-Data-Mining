...
class DiseasePrediction:
    ...
    def __init__(self, model_name=None):
        ...
        print("Available methods in DiseasePrediction:", dir(self))
        # Load Config File
        try:
    ...
    def select_model(self):
        if self.model_name == 'decision_tree':
            ...
            raise ValueError("Model name not recognized. Please choose 'decision_tree' or 'random_forest'.")
...
if __name__ == "__main__":
    ...
    current_model_name = 'random_forest'  # Updated to correct model name
